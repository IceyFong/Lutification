...
const sc_lv<32> Mem2Stream::ap_const_lv32_D = "1101";
const sc_lv<4> Mem2Stream::ap_const_lv4_D = "1101";
const sc_lv<4> Mem2Stream::ap_const_lv4_1 = "1";
...
Mem2Stream::Mem2Stream(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_3_fu_134_p2);
    sensitive << ( i_reg_93 );

    SC_METHOD(thread_in_V1_cast9_fu_108_p1);
    sensitive << ( in_V1 );
    ...
    sensitive << ( in_V1_cast9_fu_108_p1 );
    sensitive << ( tmp_cast8_fu_104_p1 );

    SC_METHOD(thread_tmp_cast8_fu_104_p1);
    sensitive << ( tmp_8 );
    ...
    sc_trace(mVcdFile, i_3_fu_134_p2, "i_3_fu_134_p2");
    ...
    sc_trace(mVcdFile, in_V1_cast9_fu_108_p1, "in_V1_cast9_fu_108_p1");
    sc_trace(mVcdFile, tmp_cast8_fu_104_p1, "tmp_cast8_fu_104_p1");
...
void Mem2Stream::thread_i_3_fu_134_p2() {
    i_3_fu_134_p2 = (!i_reg_93.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(i_reg_93.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void Mem2Stream::thread_in_V1_cast9_fu_108_p1() {
    in_V1_cast9_fu_108_p1 = esl_zext<62,61>(in_V1.read());
}
...
void Mem2Stream::thread_sum1_cast_fu_118_p1() {
    sum1_cast_fu_118_p1 = esl_zext<64,62>(sum1_reg_140.read());
}

void Mem2Stream::thread_sum1_fu_112_p2() {
    sum1_fu_112_p2 = (!in_V1_cast9_fu_108_p1.read().is_01() || !tmp_cast8_fu_104_p1.read().is_01())? sc_lv<62>(): (sc_biguint<62>(in_V1_cast9_fu_108_p1.read()) + sc_biguint<62>(tmp_cast8_fu_104_p1.read()));
}

void Mem2Stream::thread_tmp_cast8_fu_104_p1() {
    tmp_cast8_fu_104_p1 = esl_zext<62,32>(tmp_8.read());
}

void Mem2Stream::thread_tmp_fu_128_p2() {
    tmp_fu_128_p2 = (!i_reg_93.read().is_01() || !ap_const_lv4_D.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_93.read() == ap_const_lv4_D);
}
