...
architecture behav of Mem2Stream_1 is 
    ...
    signal i_reg_93 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal i_2_fu_134_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal in_V1_cast8_fu_108_p1 : STD_LOGIC_VECTOR (61 downto 0);
    signal tmp_9_cast_fu_104_p1 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    i_2_fu_134_p2 <= std_logic_vector(unsigned(i_reg_93) + unsigned(ap_const_lv8_1));
    in_V1_cast8_fu_108_p1 <= std_logic_vector(resize(unsigned(in_V1),62));
    ...
    sum1_fu_112_p2 <= std_logic_vector(unsigned(in_V1_cast8_fu_108_p1) + unsigned(tmp_9_cast_fu_104_p1));
    tmp_9_cast_fu_104_p1 <= std_logic_vector(resize(unsigned(tmp_6),62));
    tmp_fu_128_p2 <= "1" when (i_reg_93 = ap_const_lv8_D0) else "0";
end behav;
