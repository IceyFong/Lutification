...
#ifndef __BlackBoxJam_mul_5bkb__HH__
#define __BlackBoxJam_mul_5bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BlackBoxJam_mul_5bkb) {
    ...
    SC_CTOR(BlackBoxJam_mul_5bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
