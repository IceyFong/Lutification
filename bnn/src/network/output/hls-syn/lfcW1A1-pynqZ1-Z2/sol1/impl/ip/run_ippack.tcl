...
set Library     "hls"
set IPName      "BlackBoxJam"
set Version     "1.0"
set DisplayName "Blackboxjam"
set Revision    "2005071843"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_hostmem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_hostmem {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_hostmem"
        data_width "64"
        param_prefix "C_M_AXI_HOSTMEM"
...
## System Info
set user_parameters_list {clk_period 5.000000 machine 64 combinational 0 latency undef II x}
...
set enable_xo_gen 0
set kernel_files {/home/jf2715/BNN-PYNQ/bnn/src/network/lfcW1A1/hw/top.cpp}
if {$enable_xo_gen} {
