...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_memOutStrm_V_V \
    op interface \
    ports { memOutStrm_V_V_dout { I 64 vector } memOutStrm_V_V_empty_n { I 1 bit } memOutStrm_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_V3 \
    op interface \
    ports { out_V3_dout { I 61 vector } out_V3_empty_n { I 1 bit } out_V3_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 345 \
    name numReps_channel22 \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_numReps_channel22 \
    op interface \
    ports { numReps_channel22_dout { I 32 vector } numReps_channel22_empty_n { I 1 bit } numReps_channel22_read { O 1 bit } } \
} "
}
